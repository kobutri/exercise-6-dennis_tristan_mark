...
mymodule.write_to_vtk('../python/heat_timesteps_' + str(0), phi_0, 'heat_timesteps_'  )
...
for i in range(1,11):   #(1, 11):
    ...
    #phi_0 = mymodule.GridFunction(grid, vector)
    ...
    mymodule.write_to_vtk('../python/heat_timesteps_' + str(i), gridFunc, 'heat_timesteps_' )
