...
#include "pyiterativesolver.h"
#include "pypreconditioner.h"
#include "pysolver.h"
...
PYBIND11_MODULE(pmsc, mod)
{
    ...
    mod.def(
        "MPI_Barrier", [](MpiCommWrapper comm) { MPI_Barrier(comm); }, py::arg("communicator"));
    ...
    mod.def("multiply", static_cast<void (*)(Vector<scalar_t>&, std::shared_ptr<SparseMatrix<scalar_t>>, const Vector<scalar_t>&)>([](Vector<scalar_t>& res, std::shared_ptr<SparseMatrix<scalar_t>> lhs, const Vector<scalar_t>& rhs) {
